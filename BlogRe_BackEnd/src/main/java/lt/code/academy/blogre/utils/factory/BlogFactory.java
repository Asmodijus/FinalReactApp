package lt.code.academy.blogre.utils.factory;
...
public class BlogFactory {
    ...
    private static final int BLOG_USERS_MIN_SIZE = 1;
    private static final int POSTS_MAX_SIZE = 5;
    private static final int POSTS_MIN_SIZE = 1;
    private static final int COMMENTS_MAX_SIZE = 5;
    private static final int COMMENTS_MIN_SIZE = 1;
    ...
    private static BlogUser generateBlogUser() {
        ...
        return new BlogUser(
                name.toString(),
                "USER",
                "$2a$04$H1vbMBZafd0qZXlH1Ts6w.MZAtFRFdHORdzq4po40bXyQ.hiBLifm",
